...
def build_maze() -> Maze:
    return Maze(
        squares=(
                ...
                Square(index=3, row=0, column=3, border=Border.LEFT | Role.EXIT),
                Square(index=4, row=0, column=4, border=Border.TOP | Border.LEFT),
                Square(index=5, row=0, column=5, border=Border.TOP | Border.RIGHT),
                Square(index=6, row=0, column=6, border=Border.TOP),
                Square(index=7, row=0, column=7, border=Border.TOP | Border.LEFT, role=Role.ENTRANCE),
                ...
                Square(index=10, row=1, column=2, border=Border.RIGHT | Border.TOP),
                Square(index=11, row=1, column=3, border=Border.TOP | Border.LEFT),
                Square(index=12, row=1, column=4, border=Border.RIGHT | Border.LEFT),
                Square(index=13, row=1, column=5, border=Border.RIGHT | Border.TOP),
                Square(index=14, row=1, column=6, border=Border.TOP),
                Square(index=15, row=1, column=7, border=Border.BOTTOM),
                ...
                Square(index=20, row=2, column=4, border=Border.RIGHT | Border.LEFT, role=Role.EXIT),
                ...
                Square(index=35, row=4, column=3, border=Border.TOP | Border.BOTTOM),
                ...
                Square(index=42, row=5, column=2, border=Border.TOP | Border.LEFT),
                Square(index=43, row=5, column=3, border=Border.BOTTOM),
                Square(index=44, row=5, column=4, border=Border.TOP),
